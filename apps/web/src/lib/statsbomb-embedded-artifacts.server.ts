...
import profilesJson from "../../../../docs/model-results/artifacts/statsbomb-team-performance-profiles.json" with { type: "json" };
import backtestJson from "../../../../docs/model-results/artifacts/statsbomb-backtesting-expanded-elo.json" with { type: "json" };
