...
- Tournament projection overview section showing projected champion, runner-up, and Third Place Match contestants in a three-card grid; a portfolio readiness banner (31 knockout fixtures resolved, Live Elo + Poisson model); and anchor navigation links to R32 simulations, Round of 16, Quarterfinals, Semifinals, Final, and Champion sections. Placed immediately after the knockout bracket.
