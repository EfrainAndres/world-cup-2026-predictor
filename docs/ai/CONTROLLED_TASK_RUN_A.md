# Controlled Task Run A

Use this as the traditional-workflow comparison run.
...
Validation:
- use direct git status and standard command output only
- record any commands you run
- do not use compact helper scripts
