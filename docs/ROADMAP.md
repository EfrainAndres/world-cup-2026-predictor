...
| 12.14C | Group Detail UI: Projection Refresh Display | Surface `refreshExecution` metadata and refreshed assessment state in the group detail projection UI. | Planned |
