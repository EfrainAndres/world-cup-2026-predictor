...
function toGroupDetailMatch(entry: WorldCup2026DailyMatchEntry, warnings: readonly string[] = []): WorldCup2026GroupDetailMatch {
  return {
    ...
    ...(entry.regularTimeHomeScore === undefined ? {} : { regularTimeHomeScore: entry.regularTimeHomeScore }),
    ...(entry.regularTimeAwayScore === undefined ? {} : { regularTimeAwayScore: entry.regularTimeAwayScore }),
    ...(entry.extraTimeHomeScore === undefined ? {} : { extraTimeHomeScore: entry.extraTimeHomeScore }),
    ...(entry.extraTimeAwayScore === undefined ? {} : { extraTimeAwayScore: entry.extraTimeAwayScore }),
    ...(entry.penaltyHomeScore === undefined ? {} : { penaltyHomeScore: entry.penaltyHomeScore }),
    ...(entry.penaltyAwayScore === undefined ? {} : { penaltyAwayScore: entry.penaltyAwayScore }),
