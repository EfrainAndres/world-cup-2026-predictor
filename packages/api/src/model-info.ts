...
export function getModelInfo(): ModelInfoResponse {
  ...
  return {
    ...
    modelScope: [
      ...
      "Daily World Cup 2026 match foundation grouped by localized calendar date with normalized status mapping, provider fallback metadata, and optional snapshot association.",
      "Single-group World Cup 2026 detail foundation combining official and provisional standings, categorized fixtures, qualification context, prediction-history summaries, and provider metadata.",
      "Provider-agnostic World Cup 2026 results-provider foundation with external stub, in-memory cache fallback, local static fallback, and deterministic normalization.",
